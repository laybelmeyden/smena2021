...
<section class="main_2">
  ...
  <div class="main">
    ...
    <div class="">
      <p class="pom">- формирование первоначальных представлений об основных моделях (типах) робототехнических устройств, знакомство с историей робототехники.</p>
      <p class="pom">- совершенствование умений поиска и привлечения необходимых образовательных ресурсов из различных технических областей знаний;</p>
      <p class="pom">- свободное, грамотное владение основной технической терминологией конструирования и робототехники;</p>
      <p class="pom">- развитие познавательного интереса к робототехнике и предметам естественнонаучного цикла – физика, технология, информатика и др.;</p>
      <p class="pom">- развитие потребности в творческой самореализации средствами технического конструирования, моделирования и робототехники;</p>
      <p class="pom">- совершенствование коммуникативных способностей, навыков работы в команде.</p>
      <p class="pom">- совершенствование навыков и умений проектной деятельности</p>
    </div>
  </div>
</section>
<section class="three_sec">
  ...
  <div class="main_3">
    <div class="m3">
      <div class="m3_1">
        <span><img class="check_3" src="assets/img/chek.svg"></span>
        <p class="main_p4">Тебе от 11 до 17 лет</p>
      </div>
      <div class="m3_1">
        <span><img class="check_3" src="assets/img/chek.svg"></span>
        <p class="main_p4">Ты мечтаешь стать частью мира технологий</p>
      </div>
      <div class="m3_1">
        <span><img class="check_3" src="assets/img/chek.svg"></span>
        <p class="main_p4">У тебя есть идея проекта, которую ты хочешь реализовать на высшем уровне</p>
      </div>
    </div>
    <div class="m3_2">
    ...
    <div class="col s12 m4">
      <div class="card">
        <div class="card-image">
          <img src="storage/{{ $new->img }}">
          <span class="card-title">{!! Str::limit($new -> title, 15) !!}</span>
        </div>
...
<section>
  ...
  <div class="partners">
    ...
    <div class="part_right">
      <img class="part_img" src="assets/img/part/lintech_logo_new1.png">
    </div>
    <div class="part_right">
      <img class="part_img" src="assets/img/part/SkART.png">
    </div>
    <div class="part_left">
      <img class="part_img" src="assets/img/part/asi.png">
    </div>
    <div class="part_right">
