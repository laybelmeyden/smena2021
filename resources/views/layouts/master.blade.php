...
Всероссийская профильная смена по робототехнике и техническим видам спорта" />
  ...
  <link type="text/css" rel="stylesheet" href="assets/css/gal.css" />
  ...
  <noscript>
    <div><img src="https://mc.yandex.ru/watch/56356774" style="position:absolute; left:-9999px;" alt="" /></div>
  </noscript>
  <!-- /Yandex.Metrika counter -->
...
<body>
  ...
  <div class="col s12 m12 l12  alert">
    <div class="card card-green">
      <div class="card-content white-text">
        <span class="card-title">{{ session('flash_message') }}</span>
      </div>
    </div>
  </div>
  @endif
